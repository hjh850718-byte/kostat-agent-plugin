...
PO PDF → Excel 입력, OOR Bring Forward 분석, 커미션 인보이스 생성, EOD KPT 회고, 아침 브리핑, 보고서 3인 팀 등 12개 스킬을 제공합니다.
...
| kostat-report-team | 보고서 3인 팀(양식/작성/대조) 운영 | '양식 담당 호출', '작성 담당 호출', '대조 담당 호출' | L1 |
